                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" @submit.prevent="update">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <input type="file" class="form-control" id="file" name="file" @input="data.image=$event.target.files[0]" >
                                </div>
...
export default {
    ...
    methods:{
        ...
        getBook(){
          axios.get('/api/getbook/'+this.$route.params.id).then((res)=>{
              this.data=res.data;
                console.log(res)
          })
        },
        update(){
            ...
            axios.post('/api/updatebook/'+this.$route.params.id,formData,config).then((res)=>{
